...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Count success (class=1) for all sites
        ...
        # Filter for the selected site and count success/failure
...
def update_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        # Filter data for all sites within the payload range
        ...
        fig = px.scatter(
            ...
            title='Payload vs. Mission Outcome (All Sites)'
        )
    else:
